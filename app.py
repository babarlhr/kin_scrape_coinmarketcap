...
def insert_to_db(list_currencies):
    client = MongoClient("mongodb://kikin:kikin@cluster0-shard-00-00.6fuce.mongodb.net:27017,cluster0-shard-00-01.6fuce.mongodb.net:27017,cluster0-shard-00-02.6fuce.mongodb.net:27017/<dbname>?ssl=true&replicaSet=atlas-8felrw-shard-0&authSource=admin&retryWrites=true&w=majority")
...
def scrape(url):
    ...
    # Keymap for refresh chrome page. Ctrl+R
